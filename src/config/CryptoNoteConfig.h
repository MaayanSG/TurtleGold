...
const uint64_t DIFFICULTY_TARGET_V2_HEIGHT                   = 1000000; // placeholder
...
const uint64_t EMISSION_SPEED_FACTOR_V2_HEIGHT               = 1000000; // placeholder
...
const char     LATEST_VERSION_URL[]                          = "https://github.com/turtlegold/TurtleGold/releases/tag/v6.1.0";
